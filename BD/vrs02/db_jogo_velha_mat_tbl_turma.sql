...
CREATE TABLE `tbl_turma` (
  ...
  `nome_turma` varchar(255) COLLATE utf8_bin NOT NULL,
  `id_serie` int(11) NOT NULL,
  `created` varchar(45) COLLATE utf8_bin NOT NULL,
  `modified` datetime NOT NULL,
  PRIMARY KEY (`id_turma`),
  KEY `fk_id_serie_idx` (`id_serie`),
  CONSTRAINT `fk_id_serie` FOREIGN KEY (`id_serie`) REFERENCES `tbl_serie` (`id_serie`)
...
-- Dump completed on 2019-05-28 19:36:25
